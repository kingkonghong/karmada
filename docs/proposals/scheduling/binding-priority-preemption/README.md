...
type Placement struct {
    ...
    // PriorityClassSource determines whether the priorityClass field refers to PodPriorityClass, KubePriorityClass or FederatedPriorityClass.
    // Workload's PriorityClass can accept the name of a PodPriorityClass, a KubePriorityClass or a workloadPriorityClass.
    // +optional
